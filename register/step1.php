...
<head>
    ...
    <!----======== CSS ======== -->
    <link rel="stylesheet" href="css/setup1.css">
...
<body>
    ...
    <section class="home">
        <div class="text">Setup your monthly income 1/4</div>
            ...
            <section class="container forms">
                <div class="form login">
                    <div class="form-content">
                        ...
                        <form name = "income" method = "POST" action = "../function/run.php">
                            <div class="field input-field">
								<input type = "text" name = "idUser" value = "<?php echo $_COOKIE['idUser']; ?>" hidden/>
                                <input type="text" name = "incomeSource" placeholder="Income Source" class="input">
                            </div>
                            ...
                            <div class="field input-field">
                                <input type="date" placeholder="Next deposit date" class="input" name = "nextDeposit">
                                <!-- <i class='bx bx-hide eye-icon'></i> -->
                            </div>
                            <!-- <div class="form-link">
                            ...
                            <div class="field button-field">
                                <button type="submit" name = "createMonthlyIncome">Save</button>
                            </div>
                        </form>
