...
<body>
    ...
    <section class="home">
        <div class="text">Set up spending categories 3/4</div>
        <!-- CODING NYA MULAI DISINI BUAT BIKIN FITUR2 NYA -->
            <!-- <div class="text">Dashboard</div> -->
            <section class="container forms">
                <div class="form login">
                    <div class="form-content">
                        <header>Add spending categories</header>
                        <form name = "spendingCategories" method = "POST" action = "../function/run.php">
                            <div class="field input-field">
								<input type = "text" name = "idUser" value = "<?php echo $_COOKIE['idUser']; ?>" hidden/>
                                <input type="text" name = "categories" placeholder="Categories" class="input">
                            ...
                            <div class="field input-field">
                                <input type="date" placeholder="Next till due" class="input" name = "nextDeposit">
                                <!-- <i class='bx bx-hide eye-icon'></i> -->
                            </div>
                            <!-- <div class="form-link">
                            ...
                            <div class="field button-field">
                                <button type="submit" name = "createSpendingCategories">Save</button>
                            </div>
                        </form>
